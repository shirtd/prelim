...
It can be shown that there are inclusions between the nerves $\N(\cV)\subseteq \N(\cV)$ as well as the homotopy colimits of the diagrams of spaces associated with $\cU$ and $\cV$ (see Koslov~\ref{todo}).
