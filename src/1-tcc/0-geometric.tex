...
We note that, for a function in two dimensions, this translates to features in dimension 1 disappearing right after $\omega$ is the sub-levelset filtration, as shown in Figure~\ref{fig:assumption1}.
The reason for this dimension shift involves Alexander duality, and is discussed in more detail in Appendix~\ref{apx:duality}.
