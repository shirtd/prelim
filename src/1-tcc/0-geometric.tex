...
% \begin{figure}[htbp]\label{fig:assumption_1}
%   \centering
...
%   \includegraphics[trim=200 375 200 200, clip, scale=0.35]{scripts/figures/scalar_a1_B.png}
%   \includegraphics[trim=0 350 0 370, clip, scale=0.2]{scripts/figures/scalar_a1_B_top.png}
%   \includegraphics[trim=200 375 200 200, clip, scale=0.35]{scripts/figures/scalar_a1_C.png}
%   \includegraphics[trim=0 350 0 370, clip, scale=0.2]{scripts/figures/scalar_a1_C_top.png}
