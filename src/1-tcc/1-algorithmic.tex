...
\begin{proof}
  ...
  Because $\e > \varrho_D$ the covers by metric balls associated with $P^\e$ and $S^\e$ are good, so we have isomorphisms $\N : \hom_d(\cech^\e(P, S))\to \hom_d(P^\e, Q^\e)$ for all $S\subseteq P$ by the Nerve Theorem.
...
So the isomorphisms $\N_w^\e$ and $\N_z^\eta$ commute with maps $q_{\cech}$ and $q : \hom_k(P^\e, Q_w^\e)\to\hom_k(P^\eta, Q_z^\eta)$  induced by inclusion, thus $\rk~q = \rk~q_{\cech} \geq \rk~q_{\rips}$.
