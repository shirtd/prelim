...
In the following section we will compare the relative and truncated diagrams to the \textbf{restricted diagram}, defined to be that of the sublevel set filtration of $f\rest_{D\setminus B_\omega}$.% $\{f\rest_{D\setminus B_\omega}^{-1}((-\infty,\alpha])\}_{\alpha\in\R}$ of $f\rest_{D\setminus B_\omega}$.
