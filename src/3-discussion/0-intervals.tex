...
\begin{lemma}
  ...
  Suppose $\I^k$ is a collection of intervals that decompose the $k$th persistent homology module of the sublevel set filtration $\{B_\alpha\}_{\alpha\in\R}$ of $f$ for all $k$.
