...
In order to get an initial sense of the difference between relative and restricted diagrams we first compared the bottleneck distance of each to the truncated diagram.
