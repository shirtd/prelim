...
\begin{wrapfigure}{r}{0.4\textwidth}
  \centering
  \includegraphics[trim=50 150 0 200, clip, scale=0.2]{scripts/figures/scalar.png}
  \includegraphics[trim=100 25 100 0, clip, angle=270, scale=0.3]{scripts/figures/scalar_contour.png}
\end{wrapfigure}
