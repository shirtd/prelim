...
% \newcommand{\subi}[2]{_{#2{\scriptscriptstyle\rest #1}}}
% \newcommand{\subi}[2]{_{\scriptscriptstyle \lfloor#2\rfloor_{#1}}}
% \newcommand{\subi}[2]{_{\scriptscriptstyle #2;#1}}
...
\renewcommand{\D}[2]{\mathcal{D}\subi{#1}{#2}}
% \newcommand{\DD}[1]{\mathbb{D}\subi{#1}{\cdot}}
...
% \newcommand{\PP}[2]{\mathbb{P}\subi{#1}{\cdot}^{#2}}
