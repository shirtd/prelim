...
\begin{abstract}
  ...
  The topological coverage criterion (TCC) can be used to test whether an underlying space is sufficiently well sampled by a given data set.
  ...
  This unifies the two techniques as a way to conduct verified scalar field analysis, while extending SFA to instances of \emph{partial coverage}.
  Additional work utilizes the TCC as a way to compute a \emph{fundamental class} that can be used to apply duality within the persistence computation.
\end{abstract}
