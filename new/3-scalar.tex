...
\begin{proof}
  ...
  % It therefore follows that $\b\subseteq \Q^\of \sqcup (D\setminus \P) = \widehat{\Q^\of}$.
\end{proof}
...
So $\b\subseteq \B\subseteq \BB$ all surround $D$ in $\R^d$ and $\Q^\of$ and $\QQ^\of$ surround $P^\of$ in $D$ where
