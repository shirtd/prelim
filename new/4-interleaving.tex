...
% \end{tiny}
  ...
  \begin{enumerate}[label=\Roman*.]
    \item $\im~\psi_\alpha^\beta = \im~d_\alpha^\beta\rest_{\im~g_\alpha}$ is a subspace of $\im~g_\beta = \Psi_\beta$ as Diagram~\ref{dgm:gcd} commutes for all $\beta\geq\alpha$, so
    ...
    \item Because Diagrams~\ref{dgm:fab} and~\ref{dgm:gcdfab} commute for all $\alpha\leq\beta$ we have that $\im~\phi_\alpha^\beta = \im~b_\alpha^\beta\rest_{\im~f_\alpha}$ is a subspace of $\im~f_\beta = \Phi_\beta$ and $\im~\nu_{\alpha-\e} = \im~v_{\alpha-\e}\rest_{\im~g_{\alpha-\e}}$ is a subspace of $\im~f_\alpha = \Phi_\alpha$, respectively.
      Therefore,
    ...
    \item As we have shown,
      ...
      Because $(F_\alpha, B_\alpha)\sim_\e (G_\alpha, D_\alpha)$, $d_\alpha^\beta\circ n_{\alpha-\e} = n_{\beta-\e}\circ b_{\alpha-\e}$, therefore
      \begin{align*}
        \mu_{\beta - \e}\circ \phi_{\alpha-\e}^{\beta-\e} &= n_{\beta-\e}\circ b_{\alpha-\e}^{\beta-\e}\rest_{\Phi_{\alpha-\e}}\\
    ...
    \item As we have shown,
      ...
      Because $(F_\alpha, B_\alpha)\sim_\e (G_\alpha, D_\alpha)$, $b_\alpha^\beta\circ v_{\alpha-\e} = v_{\beta-\e}\circ d_{\alpha-\e}^{\beta-\e}$, therefore
      \begin{align*}
