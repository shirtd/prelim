...
\begin{figure}[htbp]
  \centering
  \includegraphics[trim=0 300 0 300, clip, width=0.4\textwidth]{figures/torus1_light-comp.pdf}
  \includegraphics[trim=0 300 0 300, clip, width=0.4\textwidth]{figures/torus2_light-comp.pdf}
