...
% % Moreover, while the original TCC made assumptions that relied only on the geometry of the boundary~\cite{desilva07coverage},
%
...
% % We will require a sublevel set $B_\omega$ to serve as our boundary in terms of a surrounding pair $(D, B_\omega)$.
