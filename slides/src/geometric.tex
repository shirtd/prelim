...
\begin{frame}
  ...
  \begin{small}
    ...
    \only<2,3>{Let $i : \hom_0(\overline{Q_1^\delta}, \overline{P^\delta})\to \hom_0(\overline{Q_0^\delta}, \overline{P^\delta})$.}

    \only<3>{\begin{lemma}\label{lem:psurj}
...
\begin{frame}
  ...
  \begin{textblock*}{11cm}(1cm,5cm)
    ...
    \only<3>{\[\begin{tikzcd}[ampersand replacement=\&]
