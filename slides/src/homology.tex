...
\begin{frame}
  ...
  \begin{textblock*}{12cm}(1cm,4.5cm)
    ...
    \includegraphics<2>[trim=75 400 75 500, clip, width=0.5\textwidth]{figures/rips/rips2}
...
\begin{frame}
  ...
  \begin{textblock*}{12cm}(1cm,4.5cm)
    ...
    \includegraphics<4>[trim=75 400 75 500, clip, width=0.5\textwidth]{figures/rips/rips2}
  \end{textblock*}
\end{frame}
