...
\begin{frame}
  ...
  \begin{textblock*}{11cm}(1cm,4.5cm)
    ...
    \includegraphics<3>[trim=0 0 -400 0, clip, width=0.3\textwidth]{figures/edge_bdy}
    \includegraphics<3>[trim=0 0 -200 0, clip, width=0.3\textwidth]{figures/tri_loop}
    \includegraphics<3>[trim=-200 0 0 0, clip, width=0.3\textwidth]{figures/tet_void}
  \end{textblock*}
\end{frame}
...
\begin{frame}
  ...
  \begin{textblock*}{11cm}(1cm,2cm)
    \begin{small}
      ...
      $\only<1-3>{\cech^{\delta/2}(P)\only<2,3>{\subseteq \rips^\delta(P)}\only<3>{\subset\cech^\delta(P)\subset\rips^{2\delta}(P)\subset\ldots}}$
